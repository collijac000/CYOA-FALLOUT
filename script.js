...
let fsd1=function(){
  ...
  document.getElementById("choices").innerHTML="<br><input type='radio' onclick='nv1()>'"
}else{
...
let radscorpp=function(){
  ...
  let mw2=function(){
    ...
    if(mwchance==1){
      document.getElementById("words").innerHTML="You stubled across a gas station and explroed inside. You fond 500 caps"
      document.getElementById("choices").innerHTML="<br><input type='radio'onclick=nv1()>Go Back<br><input type='radio'onclick='mw2()'>Keep Exploring"
      caps+=500;
    ...
    if(caps>=1){
        caps=0;
        document.getElementById("choices").innerHTML="<br><input type='radio'onclick='nv1()'>Go Back<br><input type='radio'onclick='mw1()'>Keep Exploring"
        document.getElementById("words2").innerHTML="<br><b>All caps gone</b>"
     } else{
        document.getElementById("words2").innerHTML="<br>They realized you dont have any caps and killed you<b> You Died</b>"
        document.getElementById("choices").innerHTML=""
